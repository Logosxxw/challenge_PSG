...
flags.DEFINE_boolean('predict_y', None, 'predict_y')
...
def main(_):
    ...
    # 特征变换
    num_features = self_fields.union(opp_fields).union({'last_y' if predict_y else 'last_x'})
    str_features = {'period', 'last_team', 'last_position', 'last1_event', 'last2_event'}.union(add_pisition_fields)
